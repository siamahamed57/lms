...
<head>
    ...
    <title>Lesson Management Dashboard</title>
    ...
    <style>
        ...
        .container { max-width: 1280px; width: 1280px; height: 820px; margin: 0 auto; background: rgba(0, 0, 0, 0); backdrop-filter: blur(20px); border-radius: 24px; padding: 32px; box-shadow: var(--shadow-lg); border: 1px solid rgba(255, 255, 255, 0.2); overflow: hidden; position:fixed; }
        .header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 32px; }
        .title { font-size: 28px; font-weight: 800; background: var(--gradient); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }
        ...
        .search-btn { position: absolute; right: 8px; top: 50%; transform: translateY(-50%); background: var(--gradient); border: none; padding: 12px 16px; border-radius: 12px; color: white; cursor: pointer; }
